...
class AsyncMapperFactoryBeanTest extends AbstractMyBatisSpringTest {
  ...
  private void find() throws Exception {
    find(AsyncMapperFactoryBeanTest.sqlSessionTemplate, true);
  }
  ...
  private void find(SqlSessionTemplate sqlSessionTemplate, boolean addToConfig) throws Exception {
    ...
    AsyncMapperFactoryBean<TestMapper> mapper = new AsyncMapperFactoryBean<TestMapper>();
